  ...
  <div class="text-center hero-content">
    <div class="max-w-lg">
      <h1 class="mb-5 text-5xl font-bold">
           ...
           <div className="md:flex md:flex-row flex-start justify-center">
              <div className="justify-center pt-5">
                <p className="leading-normal text-lg text-center md:text-2xl mb-8 text-center md:text-center slide-in-bottom-subtitle">
